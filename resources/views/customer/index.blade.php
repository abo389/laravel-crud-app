            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-md-2 text-end">
                        <a href="{{ route("customer.trash") }}" class="btn btn-secondary"><i class="fas fa-trash-alt"></i> Trash</a>
                    </div>
                    </div>
                    ...
                    <table class="table table-bordered" style="border: 1px solid #dddddd">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $d->bank }}</td>
                            <td>
                                <a href="{{ route("customer.edit", $d->id) }}" style="color: #2c2c2c;" class="ms-1 me-1"><i class="far fa-edit"></i></a>
                                <a href="{{ route("customer.show", $d->id) }}" style="color: #2c2c2c;" class="ms-1 me-1"><i class="far fa-eye"></i></a>
                                <form class="d-inline" action="{{ route("customer.destroy",$d->id) }}" method="POST">
                                    @csrf
                                @method("DELETE")
